        ...
        <tr valign="top">
            <td width=45%>
                <table width="100%">
                    ...
                    <tr>
                        <td>Nombre comercial: {{ $emisor[0]["nombreComercial"] ?? ($emisor[0]["nombre"] ?? '') }}</td>
                    </tr>
                    <tr>
            ...
            <td width="480px">
                <table width="100%" style="border-top:1px solid #000;">
                    ...
                    <tr>
                        ...
                        <td>{{ isset($cliente[0]['municipio']) ? get_name_municipio($cliente[0]['municipio']) : '' }}</td>
                    ...
                    <tr>
                        ...
                        <td>{{ isset($cliente[0]['departamento']) ? get_name_departamento($cliente[0]['departamento']) : '' }}</td>
                ...
                <tr>
                    <td width="490px">
                        <table width="100%">
                            ...
                            <tr>
                                <td>{{ $json["extension"]["nombEntrega"] ?? $usuario->nombre }}</td>
