                ...
                <tr>
                    <td width="490px">
                        <table width="100%">
                            ...
                            <tr>
                                <td width="245px"><strong>Nombre entrega</strong> {{$json["extension"]["nombEntrega"]  ?? $usuario->nombre}}</td>
                                <td><strong>No Documento</strong> {{$json["extension"]["docuEntrega"] ?? $usuario->nit}}</td>
                            </tr>
                            <tr>
